...
export const messages: Record<Locale, Messages> = {
  es: {
    ...
    document: {
      ...
      company: 'COSTA NORTE PROPIEDADES',
      meta: 'CUIT 30-71846291-4 · Matrícula CUCICBA 7421 · Av. del Libertador 2380 · operaciones@costanorteprop.com',
      ...
      templates: [
        { code: 'RESERVA_COMPRA', label: 'Reserva de compra', tag: 'Venta', title: 'RESERVA DE COMPRA', paragraphs: ['En la ciudad de Buenos Aires, la interesada Sofía Alvarez, DNI 32.884.219, formula reserva por la propiedad ubicada en Gorriti 6045, 8B, Palermo Hollywood, por el precio de US$ 268.000.', 'La operación queda vinculada al expediente INM-RES-2026-014, con seña registrada por US$ 8.000, documentación adjunta, estado de avance y registro de aprobaciones.'], signatures: ['Comprador', 'Vendedor', 'Inmobiliaria'] },
        { code: 'AUTORIZACION_VENTA', label: 'Autorización de venta', tag: 'Captación', title: 'AUTORIZACIÓN DE VENTA', paragraphs: ['La propietaria Carolina Vega autoriza a Costa Norte Propiedades a ofrecer comercialmente la propiedad ubicada en Av. de los Lagos 1240, Casa 18, Nordelta, bajo las condiciones pactadas en la ficha de publicación.', 'La autorización incluye difusión, coordinación de visitas, recepción de consultas y preparación de documentación comercial previa a la operación.'], signatures: ['Propietario', 'Martillero', 'Inmobiliaria'] },
        { code: 'CONTRATO_ALQUILER', label: 'Contrato base de alquiler', tag: 'Alquiler', title: 'CONTRATO DE ALQUILER', paragraphs: ['Entre Marina Sosa y Grupo Celer S.A. se acuerda la locación del inmueble ubicado en Av. del Libertador 14520, oficina 604, San Isidro, por el plazo de 36 meses y canon mensual de $ 920.000.', 'El contrato queda sujeto a revisión profesional, documentación respaldatoria, garantías informadas y aprobación final de las partes.'], signatures: ['Locador', 'Locatario', 'Inmobiliaria'] },
        { code: 'RECIBO_SENA', label: 'Recibo de seña', tag: 'Reserva', title: 'RECIBO DE SEÑA', paragraphs: ['La inmobiliaria deja constancia de haber recibido de Nicolás Paredes la suma de US$ 8.000 en concepto de seña para la operación sobre el inmueble Gorriti 6045, 8B, Palermo Hollywood.', 'El presente recibo queda asociado al expediente comercial INM-RES-2026-014, con vencimiento de confirmación el día 5 de julio de 2026.'], signatures: ['Cliente', 'Responsable', 'Inmobiliaria'] },
        { code: 'ENTREGA_LLAVES', label: 'Acta de entrega de llaves', tag: 'Cierre', title: 'ACTA DE ENTREGA DE LLAVES', paragraphs: ['En la fecha 28 de junio de 2026, se deja constancia de la entrega de llaves del inmueble ubicado en Moldes 2140, 5A, Belgrano R a favor de Valentina Ríos.', 'Las partes manifiestan recibir el inmueble según el estado informado en la documentación adjunta y dejan constancia para seguimiento posterior.'], signatures: ['Entrega', 'Recibe', 'Inmobiliaria'] },
      ],
    },
...
messages.en = {
  ...
  document: {
    ...
    company: 'COSTA NORTE PROPERTIES',
    meta: 'Tax ID 30-71846291-4 · Broker license CUCICBA 7421 · Av. del Libertador 2380 · operations@costanorteprop.com',
    ...
    templates: [
      { code: 'RESERVA_COMPRA', label: 'Purchase reservation', tag: 'Sale', title: 'PURCHASE RESERVATION', paragraphs: ['In Buenos Aires, Sofía Alvarez, ID 32.884.219, places a reservation for the property located at Gorriti 6045, 8B, Palermo Hollywood, for the price of US$ 268,000.', 'The operation is linked to case INM-RES-2026-014, with a US$ 8,000 deposit, attached documentation, progress status and approval record.'], signatures: ['Buyer', 'Seller', 'Agency'] },
      { code: 'AUTORIZACION_VENTA', label: 'Sale authorization', tag: 'Listing', title: 'SALE AUTHORIZATION', paragraphs: ['Owner Carolina Vega authorizes Costa Norte Properties to commercially offer the property located at Av. de los Lagos 1240, House 18, Nordelta, under the conditions agreed in the listing file.', 'The authorization includes publication, visit coordination, inquiry intake and commercial documentation before the operation.'], signatures: ['Owner', 'Broker', 'Agency'] },
      { code: 'CONTRATO_ALQUILER', label: 'Base rental contract', tag: 'Rental', title: 'RENTAL CONTRACT', paragraphs: ['Between Marina Sosa and Grupo Celer S.A., the lease of the property located at Av. del Libertador 14520, office 604, San Isidro, is agreed for 36 months and a monthly rent of $ 920,000.', 'The contract remains subject to professional review, supporting documentation, reported guarantees and final approval by the parties.'], signatures: ['Landlord', 'Tenant', 'Agency'] },
      { code: 'RECIBO_SENA', label: 'Deposit receipt', tag: 'Reservation', title: 'DEPOSIT RECEIPT', paragraphs: ['The agency records receipt from Nicolás Paredes of US$ 8,000 as deposit for the operation over the property Gorriti 6045, 8B, Palermo Hollywood.', 'This receipt is linked to commercial case INM-RES-2026-014, with confirmation deadline on July 5, 2026.'], signatures: ['Client', 'Responsible', 'Agency'] },
      { code: 'ENTREGA_LLAVES', label: 'Key handover record', tag: 'Closing', title: 'KEY HANDOVER RECORD', paragraphs: ['On June 28, 2026, this record confirms the delivery of keys for the property located at Moldes 2140, 5A, Belgrano R to Valentina Ríos.', 'The parties acknowledge receiving the property according to the condition reported in the attached documentation and leave record for later follow-up.'], signatures: ['Delivering party', 'Receiving party', 'Agency'] },
    ],
  },
...
messages.pt = {
  ...
  document: {
    ...
    company: 'COSTA NORTE PROPIEDADES',
    meta: 'CUIT 30-71846291-4 · Matrícula CUCICBA 7421 · Av. del Libertador 2380 · operações@costanorteprop.com',
    ...
    templates: [
      { code: 'RESERVA_COMPRA', label: 'Reserva de compra', tag: 'Venda', title: 'RESERVA DE COMPRA', paragraphs: ['Na cidade de Buenos Aires, a interessada Sofía Alvarez, DNI 32.884.219, formaliza reserva pelo imóvel localizado em Gorriti 6045, 8B, Palermo Hollywood, pelo preço de US$ 268.000.', 'A operação fica vinculada ao processo INM-RES-2026-014, com sinal registrado de US$ 8.000, documentação anexada, estado de avanço e registro de aprovações.'], signatures: ['Comprador', 'Vendedor', 'Imobiliária'] },
      { code: 'AUTORIZACION_VENTA', label: 'Autorização de venda', tag: 'Captação', title: 'AUTORIZAÇÃO DE VENDA', paragraphs: ['A proprietária Carolina Vega autoriza Costa Norte Propiedades a oferecer comercialmente o imóvel localizado em Av. de los Lagos 1240, Casa 18, Nordelta, sob as condições acordadas na ficha de publicação.', 'A autorização inclui divulgação, coordenação de visitas, recepção de consultas e preparação documental antes da operação.'], signatures: ['Proprietário', 'Corretor', 'Imobiliária'] },
      { code: 'CONTRATO_ALQUILER', label: 'Contrato base de aluguel', tag: 'Aluguel', title: 'CONTRATO DE ALUGUEL', paragraphs: ['Entre Marina Sosa e Grupo Celer S.A. fica acordada a locação do imóvel localizado em Av. del Libertador 14520, escritório 604, San Isidro, pelo prazo de 36 meses e aluguel mensal de $ 920.000.', 'O contrato fica sujeito à revisão profissional, documentação de apoio, garantias informadas e aprovação final das partes.'], signatures: ['Locador', 'Locatário', 'Imobiliária'] },
      { code: 'RECIBO_SENA', label: 'Recibo de sinal', tag: 'Reserva', title: 'RECIBO DE SINAL', paragraphs: ['A imobiliária registra o recebimento de Nicolás Paredes da quantia de US$ 8.000 como sinal para a operação sobre o imóvel Gorriti 6045, 8B, Palermo Hollywood.', 'Este recibo fica associado ao processo comercial INM-RES-2026-014, com prazo de confirmação em 5 de julho de 2026.'], signatures: ['Cliente', 'Responsável', 'Imobiliária'] },
      { code: 'ENTREGA_LLAVES', label: 'Ata de entrega de chaves', tag: 'Fechamento', title: 'ATA DE ENTREGA DE CHAVES', paragraphs: ['Na data 28 de junho de 2026, registra-se a entrega das chaves do imóvel localizado em Moldes 2140, 5A, Belgrano R a Valentina Ríos.', 'As partes declaram receber o imóvel conforme o estado informado na documentação anexa e deixam registro para acompanhamento posterior.'], signatures: ['Entrega', 'Recebe', 'Imobiliária'] },
    ],
  },
